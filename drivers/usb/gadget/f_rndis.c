...
/* Qualcomm Patch :Add check before queuing notification available 20141020 Start */
	if (!req || !data || !rndis->notify->driver_data)
		return;
/* Qualcomm Patch :Add check before queuing notification available 20141020 End */

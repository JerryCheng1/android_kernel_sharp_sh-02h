/* drivers/sharp/shsensor_hub/ml630q790/shub-input_exif.c
 *
...
#include <sharp/shub_driver.h>          // SHMDS_HUB_0207_01 add

#include "shub_io.h"
#include "ml630q790.h"

// SHMDS_HUB_0701_01 mod S
...
static int shub_check_suspend_restart;          // SHMDS_HUB_0206_06 add
/* SHMDS_HUB_0207_01 add E */
...
/* SHMDS_HUB_0206_05 add E */
/* SHMDS_HUB_0206_05 del S */
//                shub_count = 0;
//                shub_full_buffer_flg = 0;
//                for (i = 0; i < 3; i++)
//                {
...
/* SHMDS_HUB_0202_01 mod S */
        ...
        return HRTIMER_RESTART;			// SHMDS_HUB_0206_04 add
/* SHMDS_HUB_0202_01 mod E */
    }

/* SHMDS_HUB_0206_04 mod S */
//    return HRTIMER_RESTART;
    return HRTIMER_NORESTART;
/* SHMDS_HUB_0206_04 mod E */
}
...
/* SHMDS_HUB_0204_02 mod S */
    ...
    param.m_iParam[4] = 7;
    param.m_iParam[5] = 7;
    param.m_iParam[6] = 0; // SHMDS_HUB_0204_04 mod ( 1->0 )
...
/* SHMDS_HUB_0204_01 SHMDS_HUB_0204_02 mod S */
    param.m_iParam[2] = 16;
    param.m_iParam[3] = 16;
    param.m_iParam[4] = 16;
...
/* SHMDS_HUB_0207_02 add E */
    ...
    if(ret == 0 && work_call) {
        schedule_work(&stop_ped_work);
        shub_check_suspend_restart = 1;             // SHMDS_HUB_0206_06 add
    }
    mutex_unlock(&shub_mutex_if);
    return ret;
}
...
/* SHMDS_HUB_0207_02 add E */
    ...
    if(ret == 0 && timer_call) {
        hrtimer_cancel(&poll_restart_ped_timer);
        hrtimer_start(&poll_restart_ped_timer, ns_to_ktime((int64_t)SHUB_INTERVAL_STOP_PED_MS * NSEC_PER_MSEC), HRTIMER_MODE_REL);
        DBG_EXIF_IO( "%s %d(ms) ---timer start---\n", __func__, SHUB_INTERVAL_STOP_PED_MS);
    }
    return ret;
}

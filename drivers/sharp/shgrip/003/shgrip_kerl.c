...
#define SHGRIP_COUNTVAL_READ_WAIT_US		(70*1000)
...
#define SHGRIP_THR_VAL_HIGH					(0x3FFF)
...
static int shgrip_ldr_read_verify(struct shgrip_drv *ctrl, unsigned long addr, int fw_index)
{
	...
	img_ptr  = (unsigned long*)&ctrl->fw_data[fw_index];
...
static int shgrip_seq_reset_recovery(struct shgrip_drv *ctrl)
{
	...
	for (i = 0; i < SHGRIP_CHANNEL_NUM; i++) {
		...
		ret = shgrip_command_prxregwr(ctrl, &(ctrl->bk_adj.ps1_val[i]));
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d ps1 err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
		ret = shgrip_command_prxregwr(ctrl, &(ctrl->bk_adj.ps2_val)[i]);
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d ps2 err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
		ret = shgrip_command_prxregwr(ctrl, &(ctrl->bk_adj.ps3_val[i]));
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d ps3 err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
		...
		ret = shgrip_command_prxregwr(ctrl, &(ctrl->bk_adj.dtl_val[i]));
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d dtl err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
		ret = shgrip_command_prxregwr(ctrl, &(ctrl->bk_adj.dtm_val[i]));
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d dtm err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
		ret = shgrip_command_prxregwr(ctrl, &(ctrl->bk_adj.pnl_val[i]));
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d pnl err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
	}
										...
										struct shgrip_sens_setting_params *data)
{
	...
	for (i = 0; i < SHGRIP_CHANNEL_NUM; i++) {
		...
		ret = shgrip_command_prxregwr(ctrl, &(data->ps1_val[i]));
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d ps1 err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
		ret = shgrip_command_prxregwr(ctrl, &(data->ps2_val)[i]);
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d ps2 err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
		ret = shgrip_command_prxregwr(ctrl, &(data->ps3_val[i]));
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d ps3 err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
		...
		if ((shgrip_smem_lth[i] == SHGRIP_THR_VAL_LOW) ||
			(shgrip_smem_lth[i] >= SHGRIP_THR_VAL_HIGH)) {
		...
		if ((shgrip_smem_hth[i] == SHGRIP_THR_VAL_LOW) ||
			(shgrip_smem_hth[i] >= SHGRIP_THR_VAL_HIGH)) {
		...
		ret = shgrip_command_prxregwr(ctrl, &(data->dtl_val[i]));
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d dtl err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
		ret = shgrip_command_prxregwr(ctrl, &(data->dtm_val[i]));
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d dtm err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
		ret = shgrip_command_prxregwr(ctrl, &(data->pnl_val[i]));
		if (ret) {
			SHGRIP_ERR("shgrip_command_prxreg ch%d pnl err. ret=%d\n", i, ret);
			return GRIP_RESULT_FAILURE;
		}
...
static int shgrip_seq_set_sensor_calibration(struct shgrip_drv *ctrl)
{
    ...
    if ((((shgrip_calb_lth[0] != SHGRIP_THR_VAL_LOW) && (shgrip_calb_lth[0] < SHGRIP_THR_VAL_HIGH)) &&
         ((shgrip_calb_hth[0] != SHGRIP_THR_VAL_LOW) && (shgrip_calb_hth[0] < SHGRIP_THR_VAL_HIGH)))
     && (((shgrip_calb_lth[1] != SHGRIP_THR_VAL_LOW) && (shgrip_calb_lth[1] < SHGRIP_THR_VAL_HIGH)) &&
         ((shgrip_calb_hth[1] != SHGRIP_THR_VAL_LOW) && (shgrip_calb_hth[1] < SHGRIP_THR_VAL_HIGH)))
     && (((shgrip_calb_lth[2] != SHGRIP_THR_VAL_LOW) && (shgrip_calb_lth[2] < SHGRIP_THR_VAL_HIGH)) &&
         ((shgrip_calb_hth[2] != SHGRIP_THR_VAL_LOW) && (shgrip_calb_hth[2] < SHGRIP_THR_VAL_HIGH)))
     && (((shgrip_calb_lth[3] != SHGRIP_THR_VAL_LOW) && (shgrip_calb_lth[3] < SHGRIP_THR_VAL_HIGH)) &&
         ((shgrip_calb_hth[3] != SHGRIP_THR_VAL_LOW) && (shgrip_calb_hth[3] < SHGRIP_THR_VAL_HIGH)))) {
        for (i = 0; i < 4; i++) {
...
static int shgrip_seq_read_thres_calibration(struct shgrip_drv *ctrl)
{
    ...
    if ((((shgrip_dur_lthr[0] != SHGRIP_THR_VAL_LOW) && (shgrip_dur_lthr[0] < SHGRIP_THR_VAL_HIGH)) &&
         ((shgrip_dur_hthr[0] != SHGRIP_THR_VAL_LOW) && (shgrip_dur_hthr[0] < SHGRIP_THR_VAL_HIGH)))
     && (((shgrip_dur_lthr[1] != SHGRIP_THR_VAL_LOW) && (shgrip_dur_lthr[1] < SHGRIP_THR_VAL_HIGH)) &&
         ((shgrip_dur_hthr[1] != SHGRIP_THR_VAL_LOW) && (shgrip_dur_hthr[1] < SHGRIP_THR_VAL_HIGH)))
     && (((shgrip_dur_lthr[2] != SHGRIP_THR_VAL_LOW) && (shgrip_dur_lthr[2] < SHGRIP_THR_VAL_HIGH)) &&
         ((shgrip_dur_hthr[2] != SHGRIP_THR_VAL_LOW) && (shgrip_dur_hthr[2] < SHGRIP_THR_VAL_HIGH)))
     && (((shgrip_dur_lthr[3] != SHGRIP_THR_VAL_LOW) && (shgrip_dur_lthr[3] < SHGRIP_THR_VAL_HIGH)) &&
         ((shgrip_dur_hthr[3] != SHGRIP_THR_VAL_LOW) && (shgrip_dur_hthr[3] < SHGRIP_THR_VAL_HIGH)))) {
        for (i = 0; i < 4; i++) {
                                        ...
                                        struct shgrip_calibration_data *calib_data)
{
    int ret;
    int i;
    unsigned short shgrip_smem_a[4], shgrip_smem_b[4], shgrip_smem_c[4];
    unsigned short shgrip_pomax_ch0, shgrip_pomax_ch1, shgrip_pomax_ch2, shgrip_pomax_ch3;
    ...
    if (sh_smem_common == NULL) {
        ...
        memcpy(shgrip_smem_a, &sh_smem_common->sh_proxgrip_a, sizeof(shgrip_smem_a));
        memcpy(shgrip_smem_b, &sh_smem_common->sh_proxgrip_b, sizeof(shgrip_smem_b));
        memcpy(shgrip_smem_c, &sh_smem_common->sh_proxgrip_c, sizeof(shgrip_smem_c));
    }
	
    shgrip_pomax_ch0 = shgrip_pomax_ch1 = shgrip_pomax_ch2 = shgrip_pomax_ch3 = 0;
    for (i = 0; i < 16; i++) {
        if( shgrip_pomax_ch0 < calib_data[i].calib_count_sensor0) {
            shgrip_pomax_ch0 = calib_data[i].calib_count_sensor0;
        }
        if( shgrip_pomax_ch1 < calib_data[i].calib_count_sensor1) {
            shgrip_pomax_ch1 = calib_data[i].calib_count_sensor1;
        }
        if( shgrip_pomax_ch2 < calib_data[i].calib_count_sensor2) {
            shgrip_pomax_ch2 = calib_data[i].calib_count_sensor2;
        }
        if( shgrip_pomax_ch3 < calib_data[i].calib_count_sensor3) {
            shgrip_pomax_ch3 = calib_data[i].calib_count_sensor3;
        }
    }
                                    ...
                                    struct shgrip_calibration_info *calib_info)
{
    ...
    ret = shgrip_seq_calibration_complete(ctrl, calib_info->calib_data);
    if (ret) {
...
static int shgrip_dev_spi_probe(struct spi_device *spi)
{
	...
	if(pin) {
		...
		pin_state = pinctrl_lookup_state(pin, "grip_pu_active");
		if(pin_state){
			ret = pinctrl_select_state(pin, pin_state);
			if(ret){
				SHGRIP_ERR("GPIO(PU) pinctrl_select_state: Err\n");
			} else {
				pin_state = NULL;
			}
		} else {
			SHGRIP_ERR("GPIO(PU) pin_state: Null\n");	
		}
	}
...
static void shgrip_get_boot_threshold(struct shgrip_drv *ctrl)
{
    ...
    if (sh_smem_common == NULL) {
        ...
        memcpy(shgrip_smem_lth, &sh_smem_common->sh_proxgrip_lth, sizeof(shgrip_smem_lth));
        memcpy(shgrip_smem_hth, &sh_smem_common->sh_proxgrip_hth, sizeof(shgrip_smem_hth));
    }
    for (i = 0; i < 4; i++) {

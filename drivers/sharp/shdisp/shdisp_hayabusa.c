...
static void shdisp_hayabusa_PowerControl_Flicker_Exchange(struct shdisp_dsi_cmd_desc desc[] , char PowerControl[][2]);
static void shdisp_hayabusa_cmd_pow_ctl_exchange(struct shdisp_dsi_cmd_desc *cmd, int array_size, int cut_version);
...
#if defined(CONFIG_ARCH_LYNX_DL80)
...
#include "./data/shdisp_hayabusa_data_default.h"
#else  /* CONFIG_ARCH_LYNX_DL80 */
#include "./data/shdisp_hayabusa_data_default.h"
#endif /* CONFIG_ARCH_LYNX_DL80 */
...
static int shdisp_hayabusa_init_flicker_param(unsigned short vcom, unsigned short vcom_low)
{
    ...
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[NO_VCOM1_L][1] = out.vcom1_l;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[NO_VCOM2_L][1] = out.vcom2_l;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[NO_VCOM12_H][1] = out.vcom12_h;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[NO_LPVCOM1][1] = out.lpvcom1;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[NO_LPVCOM2][1] = out.lpvcom2;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[NO_VCOMOFF_L][1] = out.vcomoff_l;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[NO_VCOMOFF_H][1] = out.vcomoff_h;
...
static int shdisp_hayabusa_mipi_mfr_param_setting(int id, int mfr)
{
    ...
    case SHDISP_MFR_FIXED_15HZ_LESS:
        index = SHDISP_MFR_TBL_FIX_SETTING;
        mipi_sh_hayabusa_cmd_MFR_Parameter[POS_MFR_LP3_NREF][index] = mfr;
        mipi_sh_hayabusa_cmd_MFR_Parameter[POS_MFR_LP3_ADDR23][index] = 0x37;
        break;
#ifdef SHDISP_TRV_NM2
    case SHDISP_MFR_TRV:
        index = SHDISP_MFR_TBL_FIX_SETTING;
        mipi_sh_hayabusa_cmd_MFR_Parameter[POS_MFR_LP3_NREF][index] = VAL_MFR_120HZ;
        mipi_sh_hayabusa_cmd_MFR_Parameter[POS_MFR_LP3_ADDR23][index] = 0x11;
        break;
...
static int shdisp_hayabusa_get_mfr_brightness_id(struct shdisp_panel_mode p_mode)
{
    ...
    case SHDISP_BDIC_BKL_MODE_FIX:
        if ((p_mode.bkl_param >= 1) && (p_mode.bkl_param < LOW_BKL_FIXED)) {
...
static int shdisp_hayabusa_osc_update(int internal_osc)
{
    ...
    if (internal_osc != SHDISP_MAIN_DISP_INTERNAL_OSC_TYPE_A &&
            internal_osc != SHDISP_MAIN_DISP_INTERNAL_OSC_TYPE_B) {
        SHDISP_DEBUG("out1 internal_osc is not TYPE_A or TYPE_B");
        return ret;
    }

    if (internal_osc == internal_osc_type) {
        SHDISP_DEBUG("out2 internal_osc is same");
        return ret;
    }
    ...
    if (shdisp_api_get_main_disp_status() == SHDISP_MAIN_DISP_ON) {
        ...
        shdisp_SYS_API_delay_us(40 * 1000);
        switch (internal_osc) {
        case SHDISP_MAIN_DISP_INTERNAL_OSC_TYPE_A:
                                                       ...
                                                       int set_applied_voltage)
{
    ...
    memset(hayabusa_rdata, 0, sizeof(hayabusa_rdata));
    ret = shdisp_panel_API_mipi_diag_read_reg(SHDISP_DTYPE_DCS_READ,
                                              mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGH][0],
                                              hayabusa_rdata,
                                              1);
    if (ret) {
    ...
    memset(hayabusa_rdata, 0, sizeof(hayabusa_rdata));
    ret = shdisp_panel_API_mipi_diag_read_reg(SHDISP_DTYPE_DCS_READ,
                                              mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGL][0],
                                              hayabusa_rdata,
                                              1);
    if (ret) {
        SHDISP_ERR("<RESULT_FAILURE> mipi_sharp_diag_read_reg.");
    ...
    memset(hayabusa_rdata, 0, sizeof(hayabusa_rdata));
    ret = shdisp_panel_API_mipi_diag_read_reg(SHDISP_DTYPE_DCS_READ,
                                              mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDP][0],
                                              hayabusa_rdata,
                                              1);
    if (ret) {
        SHDISP_ERR("<RESULT_FAILURE> mipi_sharp_diag_read_reg.");
    ...
    memset(hayabusa_rdata, 0, sizeof(hayabusa_rdata));
    ret = shdisp_panel_API_mipi_diag_read_reg(SHDISP_DTYPE_DCS_READ,
                                              mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDN][0],
                                              hayabusa_rdata,
                                              1);
    if (ret) {
        SHDISP_ERR("<RESULT_FAILURE> mipi_sharp_diag_read_reg.");
    ...
    memset(hayabusa_rdata, 0, sizeof(hayabusa_rdata));
    ret = shdisp_panel_API_mipi_diag_read_reg(SHDISP_DTYPE_DCS_READ,
                                              mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDP2][0],
                                              hayabusa_rdata,
                                              1);
    if (ret) {
        SHDISP_ERR("<RESULT_FAILURE> mipi_sharp_diag_read_reg.");
    ...
    memset(hayabusa_rdata, 0, sizeof(hayabusa_rdata));
    ret = shdisp_panel_API_mipi_diag_read_reg(SHDISP_DTYPE_DCS_READ,
                                              mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGHO][0],
                                              hayabusa_rdata,
                                              1);
    if (ret) {
        SHDISP_ERR("<RESULT_FAILURE> mipi_sharp_diag_read_reg.");
    ...
    memset(hayabusa_rdata, 0, sizeof(hayabusa_rdata));
    ret = shdisp_panel_API_mipi_diag_read_reg(SHDISP_DTYPE_DCS_READ,
                                              mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGLO][0],
                                              hayabusa_rdata,
                                              1);
    if (ret) {
        SHDISP_ERR("<RESULT_FAILURE> mipi_sharp_diag_read_reg.");
...
static int shdisp_hayabusa_API_diag_set_gmmtable_and_voltage(struct shdisp_diag_gamma_info *gmm_info)
{
    ...
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGH][1]    = gmm_info->vgh;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGL][1]    = gmm_info->vgl;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDP][1]  = gmm_info->gvddp;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDN][1]  = gmm_info->gvddn;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDP2][1] = gmm_info->gvddp2;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGHO][1]   = gmm_info->vgho;
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGLO][1]   = gmm_info->vglo;
...
static int shdisp_hayabusa_API_diag_set_gmm(struct shdisp_diag_gamma *gmm)
{
    ...
    switch (cut_version) {
    case VER_CUT1_0_FIB:
        gmm_info_temp.vgh         = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_VGH][1];
        gmm_info_temp.vgl         = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_VGL][1];
        gmm_info_temp.gvddp       = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_GVDDP][1];
        gmm_info_temp.gvddn       = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_GVDDN][1];
        gmm_info_temp.gvddp2      = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_GVDDP2][1];
        gmm_info_temp.vgho        = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_VGHO][1];
        gmm_info_temp.vglo        = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_VGLO][1];
        break;
    case VER_CUT1_1:
    case VER_CUT2_0:
        gmm_info_temp.vgh         = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_VGH][1];
        gmm_info_temp.vgl         = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_VGL][1];
        gmm_info_temp.gvddp       = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_GVDDP][1];
        gmm_info_temp.gvddn       = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_GVDDN][1];
        gmm_info_temp.gvddp2      = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_GVDDP2][1];
        gmm_info_temp.vgho        = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_VGHO][1];
        gmm_info_temp.vglo        = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_VGLO][1];
        break;
    default:
        gmm_info_temp.vgh         = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_VGH][1];
        gmm_info_temp.vgl         = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_VGL][1];
        gmm_info_temp.gvddp       = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_GVDDP][1];
        gmm_info_temp.gvddn       = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_GVDDN][1];
        gmm_info_temp.gvddp2      = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_GVDDP2][1];
        gmm_info_temp.vgho        = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_VGHO][1];
        gmm_info_temp.vglo        = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_VGLO][1];
        break;
    }
...
static void shdisp_hayabusa_vdd_on(void)
{
    shdisp_hayabusa_vddio_on();
#ifdef SHDISP_HAYABUSA_ADDITIONAL_VDD
    shdisp_SYS_API_Host_gpio_request(shdisp_hayabusa_vdd_gpio, "LCD_VDD");
    shdisp_SYS_API_set_Host_gpio(shdisp_hayabusa_vdd_gpio, SHDISP_GPIO_CTL_HIGH);
#endif /* SHDISP_HAYABUSA_ADDITIONAL_VDD */
}
...
{
#ifdef SHDISP_HAYABUSA_ADDITIONAL_VDD
    shdisp_SYS_API_set_Host_gpio(shdisp_hayabusa_vdd_gpio, SHDISP_GPIO_CTL_LOW);
    shdisp_SYS_API_Host_gpio_free(shdisp_hayabusa_vdd_gpio);
#endif /* SHDISP_HAYABUSA_ADDITIONAL_VDD */
    shdisp_hayabusa_vddio_off();
}
#endif /* SHDISP_HAYABUSA_VDD */
...
static void shdisp_hayabusa_hw_reset(bool reset)
{
    ...
    if (reset) {
        shdisp_SYS_API_set_Host_gpio(shdisp_hayabusa_rst_gpio, SHDISP_GPIO_CTL_LOW);
        shdisp_SYS_API_Host_gpio_free(shdisp_hayabusa_rst_gpio);
    } else {
        shdisp_SYS_API_Host_gpio_request(shdisp_hayabusa_rst_gpio, "PANEL_RST_N");
        shdisp_SYS_API_set_Host_gpio(shdisp_hayabusa_rst_gpio, SHDISP_GPIO_CTL_HIGH);
    }
}
...
static int shdisp_hayabusa_sleepout_wait_proc1(void)
{
    ...
    if (wtime < (10 * 1000)) {
        shdisp_SYS_API_delay_us((10 * 1000) - wtime);
    }
...
static int shdisp_hayabusa_sleepout_wait_proc2(void)
{
    ...
    SHDISP_PERFORMANCE("rest of all wait=%lld", ((60 * 1000) - wtime_all));

    if (wtime_all < (60 * 1000)) {
        shdisp_SYS_API_delay_us((60 * 1000) - wtime_all);
    }
...
/* ------------------------------------------------------------------------- */
/* shdisp_hayabusa_PowerControl_Flicker_Exchange                             */
/* ------------------------------------------------------------------------- */
static void shdisp_hayabusa_PowerControl_Flicker_Exchange(struct shdisp_dsi_cmd_desc desc[] , char PowerControl[][2])
{
    desc[NO_OFFSET + NO_VCOM1_L].payload   = PowerControl[NO_VCOM1_L];
    desc[NO_OFFSET + NO_VCOM2_L].payload   = PowerControl[NO_VCOM2_L];
    desc[NO_OFFSET + NO_VCOM12_H].payload  = PowerControl[NO_VCOM12_H];
    desc[NO_OFFSET + NO_LPVCOM1].payload   = PowerControl[NO_LPVCOM1];
    desc[NO_OFFSET + NO_LPVCOM2].payload   = PowerControl[NO_LPVCOM2];
    desc[NO_OFFSET + NO_VCOMOFF_L].payload = PowerControl[NO_VCOMOFF_L];
    desc[NO_OFFSET + NO_VCOMOFF_H].payload = PowerControl[NO_VCOMOFF_H];
}

/* ------------------------------------------------------------------------- */
/* shdisp_hayabusa_cmd_pow_ctl_exchange                                      */
/* ------------------------------------------------------------------------- */
static void shdisp_hayabusa_cmd_pow_ctl_exchange(struct shdisp_dsi_cmd_desc *cmd, int array_size, int cut_version)
{
    if (!cmd) {
    ...
    if (array_size < (NO_OFFSET + SHDISP_HAYABUSA_VGLO)) {
        return;
    }
    if (shdisp_panel_ctx.lcddr_phy_gmm.status == SHDISP_LCDDR_GMM_STATUS_OK) {
        cmd[NO_OFFSET + SHDISP_HAYABUSA_VGH].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGH];
        cmd[NO_OFFSET + SHDISP_HAYABUSA_VGL].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGL];
        cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDP].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDP];
        cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDN].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDN];
        cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDP2].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDP2];
        cmd[NO_OFFSET + SHDISP_HAYABUSA_VGHO].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGHO];
        cmd[NO_OFFSET + SHDISP_HAYABUSA_VGLO].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGLO];
    } else {
        switch (cut_version) {
        case VER_CUT1_0_FIB:
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGH].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_VGH];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGL].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_VGL];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDP].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_GVDDP];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDN].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_GVDDN];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDP2].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_GVDDP2];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGHO].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_VGHO];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGLO].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB[SHDISP_HAYABUSA_VGLO];
            break;
        case VER_CUT1_1:
        case VER_CUT2_0:
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGH].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_VGH];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGL].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_VGL];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDP].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_GVDDP];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDN].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_GVDDN];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDP2].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_GVDDP2];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGHO].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_VGHO];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGLO].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl_cut1_1[SHDISP_HAYABUSA_VGLO];
            break;
        default:
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGH].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_VGH];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGL].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_VGL];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDP].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_GVDDP];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDN].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_GVDDN];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_GVDDP2].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_GVDDP2];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGHO].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_VGHO];
            cmd[NO_OFFSET + SHDISP_HAYABUSA_VGLO].payload
                                            = mipi_sh_hayabusa_cmd_PowerControl[SHDISP_HAYABUSA_VGLO];
            break;
        }
    }
...
static int shdisp_hayabusa_mipi_cmd_lcd_on(void)
{
    ...
    case VER_CUT1_0_FIB:
        if (IS_FLICKER_ADJUSTED(shdisp_panel_ctx.vcom_nvram)) {
            shdisp_hayabusa_PowerControl_Flicker_Exchange(mipi_sh_hayabusa_cmds_initial20_cut1_0_FIB, mipi_sh_hayabusa_cmd_PowerControl_adjusted);
        } else {
            shdisp_hayabusa_PowerControl_Flicker_Exchange(mipi_sh_hayabusa_cmds_initial20_cut1_0_FIB, mipi_sh_hayabusa_cmd_PowerControl_cut1_0_FIB);
        }
        shdisp_hayabusa_cmd_pow_ctl_exchange(mipi_sh_hayabusa_cmds_initial20_cut1_0_FIB,
                                ARRAY_SIZE(mipi_sh_hayabusa_cmds_initial20_cut1_0_FIB), version);
        ret = MIPI_DSI_COMMAND_TX(mipi_sh_hayabusa_cmds_initial20_cut1_0_FIB);
        break;
    case VER_CUT1_1:
    case VER_CUT2_0:
        if (IS_FLICKER_ADJUSTED(shdisp_panel_ctx.vcom_nvram)) {
            shdisp_hayabusa_PowerControl_Flicker_Exchange(mipi_sh_hayabusa_cmds_initial20_cut1_1, mipi_sh_hayabusa_cmd_PowerControl_adjusted);
            shdisp_hayabusa_cmd_pow_ctl_exchange(mipi_sh_hayabusa_cmds_initial20_cut1_1,
                                    ARRAY_SIZE(mipi_sh_hayabusa_cmds_initial20_cut1_1), version);
            ret = MIPI_DSI_COMMAND_TX(mipi_sh_hayabusa_cmds_initial20_cut1_1);
        } else {
            shdisp_hayabusa_cmd_pow_ctl_exchange(mipi_sh_hayabusa_cmds_initial20_cut1_1_flicker_unadjusted,
                                    ARRAY_SIZE(mipi_sh_hayabusa_cmds_initial20_cut1_1_flicker_unadjusted), version);
            ret = MIPI_DSI_COMMAND_TX(mipi_sh_hayabusa_cmds_initial20_cut1_1_flicker_unadjusted);
        }
        break;
    default:
        if (IS_FLICKER_ADJUSTED(shdisp_panel_ctx.vcom_nvram)) {
            shdisp_hayabusa_PowerControl_Flicker_Exchange(mipi_sh_hayabusa_cmds_initial20, mipi_sh_hayabusa_cmd_PowerControl_adjusted);
        } else {
            shdisp_hayabusa_PowerControl_Flicker_Exchange(mipi_sh_hayabusa_cmds_initial20, mipi_sh_hayabusa_cmd_PowerControl);
        }
        shdisp_hayabusa_cmd_pow_ctl_exchange(mipi_sh_hayabusa_cmds_initial20,
                                ARRAY_SIZE(mipi_sh_hayabusa_cmds_initial20), version);
    ...
    switch (version) {
    case VER_CUT2_0:
        ret = MIPI_DSI_COMMAND_TX(mipi_sh_hayabusa_cmds_fifo_reset);
        if (ret != SHDISP_RESULT_SUCCESS) {
...
static int shdisp_hayabusa_init_phy_gmm(struct shdisp_lcddr_phy_gmm_reg *phy_gmm)
{
    ...
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGH][1] = phy_gmm->applied_voltage[0];
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGL][1] = phy_gmm->applied_voltage[1];
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDP][1] = phy_gmm->applied_voltage[2];
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDN][1] = phy_gmm->applied_voltage[3];
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_GVDDP2][1] = phy_gmm->applied_voltage[4];
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGHO][1] = phy_gmm->applied_voltage[5];
    mipi_sh_hayabusa_cmd_PowerControl_adjusted[SHDISP_HAYABUSA_VGLO][1] = phy_gmm->applied_voltage[6];
...
static void shdisp_hayabusa_workqueue_handler(struct work_struct *work)
{
    ...
    if (shdisp_SYS_API_get_Host_gpio(shdisp_hayabusa_mipi_err_gpio)) {

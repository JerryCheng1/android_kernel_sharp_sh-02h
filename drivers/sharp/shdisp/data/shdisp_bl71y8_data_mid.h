/* drivers/sharp/shdisp/data/shdisp_bl71y8_data_mid.h  (Display Driver)
 *
...
/* ------------------------------------------------------------------------- */
#ifndef SHDISP_BL71Y8_DATA_MID_H
#define SHDISP_BL71Y8_DATA_MID_H
...
#define SHDISP_BKL_EMERGENCY_LIMIT_AUTO_LEVEL1  (122)
#define SHDISP_BKL_EMERGENCY_LIMIT_FIX_LEVEL0   (0x71)
#define SHDISP_BKL_EMERGENCY_LIMIT_FIX_LEVEL1   (0x1A)
#define SHDISP_BKL_PWM_LOWER_LIMIT              (0x0013)
...
#endif /* SHDISP_BL71Y8_DATA_MID_H */

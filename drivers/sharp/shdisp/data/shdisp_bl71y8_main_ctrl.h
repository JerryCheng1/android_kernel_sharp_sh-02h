...
#if defined(CONFIG_ARCH_PA29) || defined(CONFIG_ARCH_DECKARD_AL20)
     {BDIC_REG_GPIO_2,              SHDISP_BDIC_STR,    0x04,                       0xFF,      0},
     {BDIC_REG_GPIO_3,              SHDISP_BDIC_STR,    0x04,                       0xFF,      0},
     {BDIC_REG_GPIO_4,              SHDISP_BDIC_STR,    0x04,                       0xFF,      0},
#endif /* CONFIG_ARCH_PA29 */

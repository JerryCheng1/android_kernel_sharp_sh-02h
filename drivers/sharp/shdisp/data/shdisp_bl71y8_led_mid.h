/* drivers/sharp/shdisp/data/shdisp_bl71y8_led_mid.h  (Display Driver)
 *
...
/* ------------------------------------------------------------------------- */
#ifndef SHDISP_BL71Y8_LED_MID_H
#define SHDISP_BL71Y8_LED_MID_H

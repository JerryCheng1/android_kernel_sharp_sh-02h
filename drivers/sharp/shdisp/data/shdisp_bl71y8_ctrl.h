...
static const shdisp_bdicRegSetting_t shdisp_bdic_bkl_on[] = {
     ...
     {BDIC_REG_SYSTEM1,             SHDISP_BDIC_SET,    BDIC_REG_SYSTEM1_BKL,       0x03,   5000}
};
...
static shdisp_bdicRegSetting_t shdisp_bdic_bkl_fix_on[] = {
     {BDIC_REG_NONE,                SHDISP_BDIC_WAIT,   0x00,                       0x00, 20 * 1000},
     {BDIC_REG_SYSTEM6,             SHDISP_BDIC_CLR,    0x00,                       0x01,      0},
     {BDIC_REG_SLOPE,               SHDISP_BDIC_STR,    0x21,                       0xFF,      0}
};
...
static const shdisp_bdicRegSetting_t shdisp_bdic_bkl_off[] = {
     {BDIC_REG_SYSTEM1,             SHDISP_BDIC_CLR,    0x00,       BDIC_REG_SYSTEM1_BKL,  15000},
     {BDIC_REG_SYSTEM6,             SHDISP_BDIC_RMW,    0x01,                       0x05,      0}
};
...
static const shdisp_bdicRegSetting_t shdisp_bdic_ps_init_als_on4[] = {
     ...
     {BDIC_REG_AR_HI_TH_L_L,        SHDISP_BDIC_STR,    0xFF,                           0xFF,       0},
     {BDIC_REG_AR_HI_TH_L_H,        SHDISP_BDIC_STR,    0x3F,                           0xFF,       0},
     {BDIC_REG_AR_LO_TH_M_L,        SHDISP_BDIC_STR,    0xEE,                           0xFF,       0},
     {BDIC_REG_AR_LO_TH_M_H,        SHDISP_BDIC_STR,    0x02,                           0xFF,       0},
     {BDIC_REG_AR_HI_TH_M_L,        SHDISP_BDIC_STR,    0xFF,                           0xFF,       0},
     {BDIC_REG_AR_HI_TH_M_H,        SHDISP_BDIC_STR,    0x3F,                           0xFF,       0},
     {BDIC_REG_AR_LO_TH_H_L,        SHDISP_BDIC_STR,    0xB8,                           0xFF,       0},
     {BDIC_REG_AR_LO_TH_H_H,        SHDISP_BDIC_STR,    0x0B,                           0xFF,       0},
...
static const shdisp_bdicRegSetting_t shdisp_bdic_ps_deinit_als_on2[] = {
     ...
     {BDIC_REG_AR_HI_TH_L_L,        SHDISP_BDIC_STR,    0xFF,                       0xFF,       0},
     {BDIC_REG_AR_HI_TH_L_H,        SHDISP_BDIC_STR,    0xFF,                       0xFF,       0},
     {BDIC_REG_AR_LO_TH_M_L,        SHDISP_BDIC_STR,    0xB8,                       0xFF,       0},
     {BDIC_REG_AR_LO_TH_M_H,        SHDISP_BDIC_STR,    0x0B,                       0xFF,       0},
     {BDIC_REG_AR_HI_TH_M_L,        SHDISP_BDIC_STR,    0xFF,                       0xFF,       0},
     {BDIC_REG_AR_HI_TH_M_H,        SHDISP_BDIC_STR,    0xFF,                       0xFF,       0},
     {BDIC_REG_AR_LO_TH_H_L,        SHDISP_BDIC_STR,    0xE0,                       0xFF,       0},
     {BDIC_REG_AR_LO_TH_H_H,        SHDISP_BDIC_STR,    0x2E,                       0xFF,       0},
...
static shdisp_bdicRegSetting_t shdisp_bdic_als_init_ps_off1[] = {
     {BDIC_REG_BANKSEL,             SHDISP_BDIC_BANK,   0x00,                       0x00,      0}
};

static const shdisp_bdicRegSetting_t shdisp_bdic_als_init_ps_off2[] = {
     {BDIC_REG_SYSTEM8,             SHDISP_BDIC_STR,    0x10,                           0xFF,   0},

     {SENSOR_REG_COMMAND1,          SHDISP_ALS_STR,     0x00,                           0xFF,   0},
     {SENSOR_REG_COMMAND2,          SHDISP_ALS_STR,     SENSOR_REG_COMMAND2_ALS_ON_VAL, 0xFF,   0},
     {SENSOR_REG_COMMAND3,          SHDISP_ALS_STRMS,   0x10,                           0xFF,   0},
     {SENSOR_REG_COMMAND4,          SHDISP_ALS_STRM,    0x00,                           0xFF,   0},
     {SENSOR_REG_COMMAND1,          SHDISP_ALS_STR,     0xD0,                           0xFF,   0},
...
static const shdisp_bdicRegSetting_t shdisp_bdic_als_init_ps_on2[] = {
     ...
     {BDIC_REG_AR_RANGE_M,          SHDISP_BDIC_STRM,   BDIC_REG_AR_RANGE_M_VAL_PS_ON,  0xFF,       0},
     {BDIC_REG_AR_RANGE_H,          SHDISP_BDIC_STRM,   BDIC_REG_AR_RANGE_H_VAL_PS_ON,  0xFF,       0},
     {BDIC_REG_NONE,                SHDISP_BDIC_WAIT,   0x00,                           0x00,   45000},
     {BDIC_REG_SYSTEM8  ,           SHDISP_BDIC_STR,    0x04,                           0xFF,       0}
};

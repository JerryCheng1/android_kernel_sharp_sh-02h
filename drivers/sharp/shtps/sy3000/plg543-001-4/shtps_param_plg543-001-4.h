/* drivers/sharp/shtps/sy3000/plg543-001-4/shtps_param_plg543-001-4.h
 *
 ...
 *
 */
#ifndef __SHTPS_PARAM_PLG543_001_4_H__
#define __SHTPS_PARAM_PLG543_001_4_H__
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_PERF_LOCK_CLOCK_FREQUENCY, 			960000);
	SHTPS_PARAM_DEF( SHTPS_PERF_LOCK_ENABLE_TIME_MS, 			50);
	SHTPS_PARAM_DEF( SHTPS_PERF_LOCK_ENABLE_TIME_MS_FOR_FLICK, 	50);
	SHTPS_PARAM_DEF( SHTPS_PERF_LOCK_ENABLE_FLICK_DIST, 		15);

	SHTPS_PARAM_DEF( SHTPS_PERF_LOCK_QOS_LATENCY_ENABLE, 		1);
	SHTPS_PARAM_DEF( SHTPS_PERF_LOCK_QOS_LATENCY_DEF_VALUE, 	399);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_X,	37);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_Y,	1182);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE,			313);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO,			81);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO_2,		105);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_EFFECT_TIME,		750);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_CANCEL_AREA_THRESH_X,	40);
	...
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_SIDE_AREA_THRESH_ZWY_RATIO,	525);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_SIDE_AREA_THRESH_W,			0);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_SIDE_AREA_THRESH_WY,			0);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_HULL_LEAVE_MAX_DOT,			79);
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_HULL_CANCEL_JUDGE_AREA,		27);
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_HULL_CANCEL_THRESHOLD,		3);

	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_EXCLUDE_DOT,					12);
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_EXCLUDE_DOT_HIGH_REPORT_RATE,9);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY_LEAVE_MAX_DOT,						34);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_TEMPERATURE_GHOST_REJECT_ENABLE,				0);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_PRM_GLOVE_CHANGE_LLF_LAND_LOCK_DISTANCE,		0x3D);
#endif /* SHTPS_DEF_GLOVE_CHANGE_LANDLIFTFILTER_ENABLE */

/* -----------------------------------------------------------------------------------
 */
#endif /* __SHTPS_PARAM_PLG543_001_4_H__ */

...
static ssize_t power_supply_show_property(struct device *dev,
	...
	static char *batfet_text[] = {
		"BATFET_OFF", "BATFET_ON"
	};
...
#ifdef CONFIG_BATTERY_SH
	else if (off == POWER_SUPPLY_PROP_ENABLE_BATFET)
		return sprintf(buf, "%s\n", batfet_text[value.intval]);
#endif /* CONFIG_BATTERY_SH */
...
#ifdef CONFIG_BATTERY_SH
	POWER_SUPPLY_ATTR(aicl_final_limit),
	POWER_SUPPLY_ATTR(charging_voltage),
	POWER_SUPPLY_ATTR(charging_current_max),
	POWER_SUPPLY_ATTR(batfet),
	POWER_SUPPLY_ATTR(usb_id_voltage),
